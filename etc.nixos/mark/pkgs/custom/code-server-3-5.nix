...
in stdenv.mkDerivation rec {
  ...
  yarnCache = stdenv.mkDerivation {
    ...
    outputHash = {
      x86_64-linux = "0vn4dpq74yj6wcb6fpi4s08y8xdxw7vz8dhvqgy0f1q877zjinpq";
  ...
  patchPhase = ''
    ...
    # fix yarn build fails due to release tarball not being a git repository (https://github.com/microsoft/vscode/issues/106245)
    substituteInPlace lib/vscode/build/npm/postinstall.js \
      --replace 'git config pull.rebase true' 'echo done!'
